...
if __name__ == '__main__':
    ...
    lossfile = open('./log/lostfile_{}_{}_{}_iid{}_DP2.dat'.format(args.dataset, args.model, args.epochs, args.iid), "w")
    ...
    plt.savefig('./log/fed_{}_{}_{}_C{}_iid{}_DP2.png'.format(args.dataset, args.model, args.epochs, args.frac, args.iid))
